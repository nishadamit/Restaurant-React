                ...
                <Row>
                        ...
                        <Form onSubmit={this.handleOnSubmit} >
                            <Form.Group as={Row} >
                                ...
                                <Col sm={10}>
                                <Form.Control type="text" id="firstname" name="firstname" placeholder="First Name" value={this.state.firstname} onChange={this.handleOnchange} />
                                </Col>
                            </Form.Group>
                            <Form.Group as={Row} >
                                <Form.Label column="true" sm={2}>Last Name</Form.Label>
                                <Col sm={10}>
                                <Form.Control type="text" id="lastname" name="lastname" placeholder="Last Name" value={this.state.lastname} onChange={this.handleOnchange} />
                                </Col>
                            </Form.Group>
                            <Form.Group as={Row} >
                                <Form.Label column="true" sm={2}>Phone Number</Form.Label>
                                <Col sm={10}>
                                <Form.Control type="text" id="phonenumber" placeholder="Phone Number" name="phonenumber" value={this.state.phonenumber} onChange={this.handleOnchange} />
                                </Col>
                            </Form.Group>
                            <Form.Group as={Row} >
                                <Form.Label column sm={2}>Email</Form.Label>
                                <Col sm={10}>
                                <Form.Control column="true" sm={10} type="text" id="email" placeholder="Email" name="email"  placeholder="Email" value={this.state.email} onChange={this.handleOnchange} />
                                </Col>
                            </Form.Group>
                            <Form.Group as={Row} >
                                <Col sm={{ span: 4, offset: 2 }} >
                                      <Form.Check type="checkbox" id="agree" name="agree" className="mb-2" label="May we contact you?" checked={this.state.agree} onChange={this.handleOnchange}  />
                                </Col>
                            ...
                            <Form.Group as={Row} >
                                ...
                                <Col sm={10}>
                                <Form.Control column="true" sm={10} as="textarea" rows="7" id="feedback" name="feedback" value={this.state.feedback} onChange={this.handleOnchange}  />
                                </Col>
                            </Form.Group>
                            <Form.Group as={Row}>
